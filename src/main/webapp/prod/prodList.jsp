...
<script type="text/javascript">
	$(document).ready(function(){
		...
		$(".prodClick").on("click", function(){
			...
			var prodId= $(this).children()[0].innerText;
				...
				<div class="row">
					<div class="col-sm-8 blog-main">
						...
						<div class="text-center">
							...
							<ul class="pagination">
								<li><a href="/prodServlet?page=1&pageSize=10"
							...
							<c:forEach begin="1" end="${pageCnt}" var="p">
									<li><a href="/prodServlet?page=${p}&pageSize=10">${p}</a></li>
								</c:forEach>
								<li><a href="/prodServlet?page=${pageCnt}&pageSize=10"
									aria-label="Next"> <span aria-hidden="true">&raquo;</span>
								</a></li> 
							</ul>
						</div>
